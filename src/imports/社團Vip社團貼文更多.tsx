import svgPaths from "./svg-r3v64a94uo";
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center p-[8px] relative shrink-0 w-[375px]" data-name="Frame">
      <div className="bg-[#7a7a7a] h-[4px] rounded-[9px] shrink-0 w-[29px]" data-name="Rounded rectangle" />
    </div>
  );
}
...
function Component9() {
  return (
    <div className="absolute left-[17px] size-[20px] top-[10px]" data-name="刪除">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="åªé¤">
          <path d={svgPaths.p17f42d00} fill="var(--fill-0, white)" id="Union" />
        </g>
      </svg>
    </div>
  );
...
function Component8() {
  return (
    <div className="bg-[#141414] h-[44px] relative shrink-0 w-[343px]" data-name="卡片/貼文更多動作">
      <Component9 />
      <p className="absolute font-['Acme:Regular','Noto_Sans_JP:Regular',sans-serif] leading-[20px] left-[48px] text-[14px] text-white top-[12px]" style={{ fontVariationSettings: "\'wght\' 400" }}>
        刪除貼文
      </p>
    </div>
  );
...
function AssetIcon1() {
  return (
    <div className="absolute left-[17px] size-[20px] top-[10px]" data-name="asset/icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="asset/icon">
          <path clipRule="evenodd" d={svgPaths.p3e912280} fill="var(--fill-0, white)" fillRule="evenodd" id="Subtract" />
        </g>
      </svg>
    </div>
  );
...
function AssetIcon2() {
  return (
    <div className="absolute left-[17px] size-[20px] top-[10px]" data-name="asset/icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="asset/icon">
          <path d={svgPaths.p2d151480} fill="var(--fill-0, white)" id="Subtract" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="absolute left-[17px] size-[20px] top-[10px]" data-name="asset/icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="asset/icon">
          <g id="Vector">
            <path d={svgPaths.p200d7a80} fill="var(--fill-0, white)" />
            <path d={svgPaths.pbf3ae80} fill="var(--fill-0, white)" />
          </g>
        </g>
      </svg>
    </div>
...
function Component14() {
  return (
    <div className="absolute left-[17px] size-[20px] top-[10px]" data-name="編輯紀錄">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="ç·¨è¼¯ç´é">
          <path d={svgPaths.p306028c0} fill="var(--fill-0, white)" id="Subtract" />
        </g>
      </svg>
    </div>
  );
...
function Component13() {
  return (
    <div className="bg-[#141414] h-[44px] relative shrink-0 w-[343px]" data-name="卡片/貼文更多動作">
      <Component14 />
      <p className="absolute font-['Acme:Regular','Noto_Sans_SC:Regular','Noto_Sans_JP:Regular',sans-serif] leading-[20px] left-[48px] text-[14px] text-white top-[12px]" style={{ fontVariationSettings: "\'wght\' 400" }}>
        查看編輯紀錄
      </p>
    </div>
  );
...
function Component7() {
  return (
    <div className="bg-[#141414] content-stretch flex flex-col items-start overflow-clip pt-[4px] relative rounded-[8px] shrink-0" data-name="按鈕列">
      <Component8 />
      <Component10 />
      <Component11 />
      <Component12 />
...
function Component6() {
  return (
    <div className="bg-[#212121] content-stretch flex flex-col gap-[8px] items-center pb-[12px] relative rounded-tl-[12px] rounded-tr-[12px] shrink-0" data-name="底部彈窗/貼文更多動作">
      <Frame />
      <Component7 />
    </div>
  );
...
function Measurements() {
  return (
    <div className="absolute contents left-[16px] top-[591px]" data-name="📐 Measurements">
      <div className="absolute bg-[rgba(118,20,245,0.5)] border border-[#7614f5] border-solid h-[44px] left-[16px] top-[591px] w-[343px]" data-name="Rectangle" />
    </div>
  );
}
      ...
      <div className="absolute inset-[-11.11%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
          <g id="åæ¨/è¡¨æç¬¦è">
            ...
            <path d={svgPaths.p36d6e800} fill="url(#paint0_radial_294_19060)" id="Oval" />
            <path d={svgPaths.p1cfb2500} fill="var(--fill-0, white)" id="Path" />
            <path d={svgPaths.p1eb85080} fill="var(--fill-0, white)" id="Path_2" />
          </g>
          <defs>
            <radialGradient cx="0" cy="0" gradientTransform="translate(11.3951 4.178) scale(15.8449)" gradientUnits="userSpaceOnUse" id="paint0_radial_294_19060" r="1">
...
function Component76() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="頁籤列/社團/選中">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g clipPath="url(#clip0_294_18984)" id="é ç±¤å/ç¤¾å/é¸ä¸­">
          <g filter="url(#filter0_d_294_18984)" id="Vector 197">
            <path d={svgPaths.p33df5480} fill="url(#paint0_linear_294_18984)" />
          </g>
        </g>
        <defs>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="22.7801" id="filter0_d_294_18984" width="27.3514" x="-1.67571" y="0.966176">
            ...
            <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_294_18984" />
            <feBlend in="SourceGraphic" in2="effect1_dropShadow_294_18984" mode="normal" result="shape" />
          </filter>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_294_18984" x1="12" x2="19.1298" y1="4" y2="15.6284">
            <stop stopColor="#FFC737" />
            <stop offset="1" stopColor="#FCA729" />
          </linearGradient>
          <clipPath id="clip0_294_18984">
