import svgPaths from "./svg-scr640qw83";
      ...
      <div className="absolute inset-[-11.11%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
          <g id="åæ¨/è¡¨æç¬¦è">
            ...
            <path d={svgPaths.p36d6e800} fill="url(#paint0_radial_298_1708)" id="Oval" />
            <path d={svgPaths.p1cfb2500} fill="var(--fill-0, white)" id="Path" />
            <path d={svgPaths.p1eb85080} fill="var(--fill-0, white)" id="Path_2" />
          </g>
          <defs>
            <radialGradient cx="0" cy="0" gradientTransform="translate(11.3951 4.178) scale(15.8449)" gradientUnits="userSpaceOnUse" id="paint0_radial_298_1708" r="1">
...
function Component76() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="頁籤列/社團/選中">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g clipPath="url(#clip0_298_1815)" id="é ç±¤å/ç¤¾å/é¸ä¸­">
          <g filter="url(#filter0_d_298_1815)" id="Vector 197">
            <path d={svgPaths.p33df5480} fill="url(#paint0_linear_298_1815)" />
          </g>
        </g>
        <defs>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="22.7801" id="filter0_d_298_1815" width="27.3514" x="-1.67571" y="0.966176">
            ...
            <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_298_1815" />
            <feBlend in="SourceGraphic" in2="effect1_dropShadow_298_1815" mode="normal" result="shape" />
          </filter>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_298_1815" x1="12" x2="19.1298" y1="4" y2="15.6284">
            <stop stopColor="#FFC737" />
            <stop offset="1" stopColor="#FCA729" />
          </linearGradient>
          <clipPath id="clip0_298_1815">
