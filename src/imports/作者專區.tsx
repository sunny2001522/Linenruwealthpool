import svgPaths from "./svg-zd5djz1cno";
...
function Measurements() {
  return (
    <div className="absolute contents left-[335px] top-[104px]" data-name="📐 Measurements">
      <div className="absolute bg-[rgba(118,20,245,0.5)] border border-[#7614f5] border-solid left-[335px] size-[24px] top-[104px]" data-name="Rectangle" />
    </div>
  );
}
      ...
      <div className="absolute inset-[-11.11%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
          <g id="åæ¨/è¡¨æç¬¦è">
            ...
            <path d={svgPaths.p36d6e800} fill="url(#paint0_radial_294_18799)" id="Oval" />
            <path d={svgPaths.p1cfb2500} fill="var(--fill-0, white)" id="Path" />
            <path d={svgPaths.p1eb85080} fill="var(--fill-0, white)" id="Path_2" />
          </g>
          <defs>
            <radialGradient cx="0" cy="0" gradientTransform="translate(11.3951 4.178) scale(15.8449)" gradientUnits="userSpaceOnUse" id="paint0_radial_294_18799" r="1">
  ...
  return (
    <div className="mr-[-4px] relative shrink-0 size-[18px] z-[3]" data-name="圖標/表情符號">
      <div className="absolute inset-[-11.11%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
          <g id="åæ¨/è¡¨æç¬¦è">
            <g clipPath="url(#clip0_294_18781)">
              <path d={svgPaths.p36d6e800} fill="url(#paint0_radial_294_18781)" id="Oval" />
              <path d={svgPaths.p1cfb2500} fill="var(--fill-0, white)" id="Path" />
              <path d={svgPaths.p1eb85080} fill="var(--fill-0, white)" id="Path_2" />
            </g>
            <rect height="20" rx="10" stroke="var(--stroke-0, #141414)" strokeWidth="2" width="20" x="1" y="1" />
          ...
          <defs>
            <radialGradient cx="0" cy="0" gradientTransform="translate(11.3951 4.178) scale(15.8449)" gradientUnits="userSpaceOnUse" id="paint0_radial_294_18781" r="1">
              <stop stopColor="#DC3A3F" />
              <stop offset="1" stopColor="#80171A" />
            </radialGradient>
            <clipPath id="clip0_294_18781">
  ...
  return (
    <div className="mr-[-4px] relative shrink-0 size-[18px] z-[2]" data-name="圖標/表情符號">
      <div className="absolute inset-[-11.11%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
          <g id="åæ¨/è¡¨æç¬¦è">
            <g clipPath="url(#clip0_294_18760)">
              <path d={svgPaths.p21639300} fill="var(--fill-0, #FED132)" id="Body 1" />
              <g id="Group">
                <path d={svgPaths.p35388d80} fill="var(--fill-0, #802D21)" id="Vector" />
                <path d={svgPaths.p165ac000} fill="var(--fill-0, white)" id="Vector_2" />
...
function Component68() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="頁籤列/社團/選中">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g clipPath="url(#clip0_294_18718)" id="é ç±¤å/ç¤¾å/é¸ä¸­">
          <g filter="url(#filter0_d_294_18718)" id="Vector 197">
            <path d={svgPaths.p33df5480} fill="url(#paint0_linear_294_18718)" />
          </g>
        </g>
        <defs>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="22.7801" id="filter0_d_294_18718" width="27.3514" x="-1.67571" y="0.966176">
            ...
            <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_294_18718" />
            <feBlend in="SourceGraphic" in2="effect1_dropShadow_294_18718" mode="normal" result="shape" />
          </filter>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_294_18718" x1="12" x2="19.1298" y1="4" y2="15.6284">
            <stop stopColor="#FFC737" />
            <stop offset="1" stopColor="#FCA729" />
          </linearGradient>
          <clipPath id="clip0_294_18718">
